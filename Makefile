...
make_list:
	gcc -g -DLIST_F -Wall -c make_list.c delta.c compute.c grobner.c helper.c pol.c scalar.c
	gcc -g -o tester make_list.o delta.o compute.o grobner.o helper.o pol.o scalar.o
